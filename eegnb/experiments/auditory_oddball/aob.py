...
def present(duration=120, n_trials=2010, iti=0.3, soa=0.2, jitter=0.2, 
            secs=0.2, volume=0.8, random_state=42, eeg=None, save_fn=None,
            s1_freq = 'C', s2_freq='D', s1_octave=5,s2_octave=6):
