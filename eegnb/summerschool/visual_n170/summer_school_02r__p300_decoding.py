...
FIG_PATH = MAIN_PATH
DEVICE_NAME = 'unicorn'
EXP_NAME= 'Summer_School_N170'

#eegnb_data_path = os.path.join(os.path.expanduser('~/'),'.eegnb', 'data')    
#p300_data_path = os.path.join(MAIN_PATH, 'visual-P300', 'eegnb_examples')
...
raw = load_data(subject,session,
                experiment=EXP_NAME, site='local', device_name=DEVICE_NAME,
...
fig.tight_layout()
plt.savefig(os.path.join(FIG_PATH, 'p300_run_n170.png'))